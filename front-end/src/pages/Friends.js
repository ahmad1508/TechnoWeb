...
export default function Main() {
  ...
  const reatePrivateChat = async (e, friendID) => {
    const private_channel = channels.filter((itm) => {
      return itm.name === user.id + friendID || itm.name === friendID + user.id;
    });
            ...
            <Box css={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <Box css={{ display: "flex", alignItems: "center" }}>
                <Button onClick={handleClick}>
                  ...
                  <Typography
                    variant="body1"
                    css={{ justifyContent: "flex-start", marginLeft: "10px" }}
                  >
                    Add Friends
                  </Typography>
                </Button>
                ...
                <Accordion css={styles.accordion} key={j++}>
                  <Grid container>
                    ...
                    <Grid item xs={4} md={2} lg={2}>
                      <Box
                        onClick={(e) => acceptInvitation(e, invite)}
                        css={styles.accept}
                      >
                        <Typography variant="body1">Accept</Typography>
                      </Box>
                      <Box
                        onClick={(e) => rejectInvitation(e, invite)}
                        css={styles.accept}
                      >
